    ...
    RestaurantMock(
        ...
        [
          ...
          MenuItemMock(4, "Cheese Loaded Burger", 99,
              "Loaded with veggies and cheese", FlavorAssets.kFood7, true),
        ],
    ...
    RestaurantMock(
        ...
        [
          MenuItemMock(
              ...
              "Pancakes",
              200,
              "Get lost in the chocolate goeeyness",
              FlavorAssets.kFood9,
              false),
    ...
    RestaurantMock(
        ...
        [
          ...
          MenuItemMock(8, "Mixed Veg Curry", 399,
              "With the goodness of vegetables", FlavorAssets.kFood5, true),
          MenuItemMock(
              9,
              "Chole Bhatura",
              199,
    ...
    RestaurantMock(
        ...
        [
          MenuItemMock(12, "Chicken Curry", 399, "With the goodness of spices",
              FlavorAssets.kFood5, false),
          MenuItemMock(
              13, "Fish fry", 299, "Spicy treat", FlavorAssets.kFood8, false),
        ],
